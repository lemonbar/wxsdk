...
public class WXMaterialService {
    ...
    public WXGetMaterialCountResponse getCount() {
    ...
    public WXGetCommonMaterialListResponse getCommonMaterialList(MaterialPageableRequest pageableRequest) {
    ...
    public WXGetNewsMaterialListResponse getNewsMaterialList(MaterialPageableRequest pageableRequest) {
        WXGetMaterialListRequest request = new WXGetMaterialListRequest(WXTokenController.getToken(), pageableRequest);
        WXGetNewsMaterialListResponse response = (WXGetNewsMaterialListResponse) WXHttpDispatch.execute(request);
        return response;
    }

    public String uploadTempMedia(MediaType type, String filePath) {
    ...
    public WXAddNewsResponse addNewsList(NewsList newsList) {
    ...
    public WXAddCommonMaterialResponse addCommonMaterial(String filePath) {
